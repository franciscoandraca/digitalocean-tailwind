<template>
  <div class="bg-blue-950 px-5 text-gray-400 py-2 text-sm">
        <div class="container mx-auto flex justify-between">
            <div class="flex items-center">
                <div>
                    Join our virtual event for Agencies & Ecommerce: Learn expert strategies to skyrocket your holiday sales
                </div>              
            ...
            <div class="flex gap-x-4 items-center">
                <a href="" class="bg-blue-800 px-3 py-1 rounded text-sky-400 font-semibold">We're Hiring</a>
                <a href="" class="hover:text-white">Blog</a>
                <a href="" class="hover:text-white">Docs</a>
                <a href="" class="hover:text-white">Get Support</a>
                <a href="" class="hover:text-white">Contact Sales</a>
            </div>
        </div>
    </div>
    <div class="shadow-md relative z-10">
        <div class="container flex justify-between items-center mx-auto py-5">
           <div class="flex items-center gap-x-6">
                ...
                <div class="flex items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-6 text-gray-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                      </svg>
                </div>  
                <a href="">Princing</a>
          ...
          <div>
                <a href="" class="border border-gray-400 px-6 py-3 rounded-lg focus:outline-dotted focus:outline-1 focus:bg-sky-100">Log In</a>
                <a href="" class="px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-900 active:bg-blue-500 active:text-sky-400  font-bold">Sign Up</a>
          </div>
        </div>
    </div>
